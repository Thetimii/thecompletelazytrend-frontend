...
const Navbar = ({ isDarkMode, toggleDarkMode }) => {
  ...
  return (
    <nav className="bg-white dark:bg-primary-800 text-primary-800 dark:text-primary-50 shadow-md fixed top-0 left-0 right-0 z-20 ml-16 lg:ml-64 transition-all duration-300">
      <div className="px-4 py-3">
        <div className="flex justify-between items-center">
          {/* Left side - Brand */}
          <div className="flex items-center">
            <span className="text-xl font-bold text-accent-600 dark:text-accent-400 hidden md:block">
              Dashboard
            </span>
          </div>
